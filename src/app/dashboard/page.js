...
export default function Dashboard() {
    ...
    if (loading) return (
        <div
            ...
            bg-[var(--layer1)] backdrop-blur-xl p-6"
        >
            <div
    ...
    return (
        <main
            className="flex flex-col bg-[var(--layer2)] min-h-screen transition-colors
            duration-300 p-6 md:p-10 w-full"
        >
            {/* Onboarding Modal */}
            {(!completedProfile) && (
                <DetailsModal
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                <div
                    className="bg-[var(--layer1)] border border-[var(--layer3)] rounded-2xl p-5 flex flex-col gap-3
                    hover:border-[var(--nice-blue)] transition-colors"
                >
                    <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path
                                d="M10 3v9m0-9-3 3m3-3 3 3M4 14h12v1a2 2 0 01-2 2H6a2 2 0 01-2-2v-1z"
                                stroke="#185FA5"
                                strokeWidth="1.5"
                                strokeLinecap="round"
                    ...
                    <button
                        ...
                        hover:bg-[var(--layer2)] transition-colors text-[var(--text)] w-fit"
                    >
                        Upload
                    </button>
                </div>
            ...
            <div
                className="bg-[var(--layer1)] border border-[var(--layer3)] rounded-2xl p-5 flex flex-col md:flex-row
                items-start md:items-center gap-4 mb-10 hover:border-[var(--nice-blue)] transition-colors"
            >
                ...
                <button
                    className="cursor-pointer text-sm font-bold bg-[var(--nice-blue)] text-white px-5 py-2.5 rounded-xl
                    shadow-lg shadow-blue-500/20 hover:scale-95 transition-transform whitespace-nowrap"
                >
                    Ask POW →
                </button>
            </div>
                        ...
                        {notes.tags?.length > 0 && (
                            <div className="flex flex-wrap gap-1 mt-2">
                                {notes.tags.map(tag => (
                                    <span
                                        key={tag}
                                        className="text-xs font-semibold bg-[var(--layer2)] text-[var(--text-muted)]
