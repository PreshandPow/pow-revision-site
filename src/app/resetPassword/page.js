                    ...
                    <div className="w-full max-w-md mx-auto">
                        <div className="flex flex-col">
                            ...
                            <input
                                ...
                                className="p-4.5 font-semibold mt-8 rounded-xl bg-[var(--layer2)] text-[var(--text-muted)] border-none outline-none focus:ring-2 focus:ring-[var(--nice-blue)] mb-6"
                                onChange={e => setConfirmPassword(e.target.value)}
                            />

                            <button className="cursor-pointer p-4 font-semibold border rounded-full w-full bg-[var(--nice-blue)] border-none shadow-lg shadow-blue-500/20 hover:scale-95 transition-transform"
                                    type={'submit'}
