...
export default function ResetPasswordPage() {
    ...
    return (
        <motion.div
            className="fixed inset-0 flex flex-col lg:flex-row w-full min-h-screen bg-[var(--layer1)]/95
            z-[60] backdrop-blur-sm"
        ...
        >
            ...
            <div
                className="relative hidden lg:flex lg:w-1/2 lg:h-screen bg-[var(--nice-blue)] p-20 sticky top-0
                overflow-hidden"
            >
                <Image
            ...
            {/* Right Side: Form */}
            <div
                className="flex-1 flex flex-col w-full min-h-screen overflow-y-auto p-8 md:p-12 lg:p-20
                bg-[var(--layer1)]"
            >
                    ...
                    <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto flex flex-col">
                        ...
                        <div className="relative mb-8">
                            <input
                                ...
                                className="p-4.5 pr-12 font-semibold border rounded-xl w-full bg-[var(--layer2)]
                                text-[var(--text-muted)] border-none focus:ring-2 focus:ring-[var(--nice-blue)] outline-none"
                        ...
                        <input
                            ...
                            className="p-4.5 font-semibold rounded-xl bg-[var(--layer2)] text-[var(--text-muted)]
                            border-none outline-none focus:ring-2 focus:ring-[var(--nice-blue)] mb-8"
                            onChange={e => setConfirmPassword(e.target.value)}
                        />

                        <button
                            type="submit"
                            className="cursor-pointer p-4 font-semibold border rounded-full w-full bg-[var(--nice-blue)]
                            text-white shadow-lg shadow-blue-500/20 hover:scale-95 transition-transform"
                        >
                            Set new password
                        </button>
                    </form>
