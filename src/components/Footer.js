            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-3 text-sm text-[var(--text-muted)]">
                            <li><Link
                                ...
                                href="#"
                                className="hover:text-[var(--nice-blue)] transition-colors">Flashcards</Link></li>
                            <li><Link
                                aria-label={'Visit our Notes page'}
                                href="/dashboard/Notes"
                                className="hover:text-[var(--nice-blue)] transition-colors">Note Maker</Link></li>
                            <li><Link
                                aria-label={'Visit our AI page'}
                                href="#"
                                className="hover:text-[var(--nice-blue)] transition-colors">POWER bot AI</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-3 text-sm text-[var(--text-muted)]">
                            <li><Link
                                aria-label={'Learn more about us'} href="#"
                                className="hover:text-[var(--nice-blue)] transition-colors">About Us</Link></li>
                            <li><Link
                                aria-label={'Look for careers with us'} href="#"
                                className="hover:text-[var(--nice-blue)] transition-colors">Careers</Link></li>
                            <li><Link
                                aria-label={'Learn about our privacy policy'} href="#"
                                className="hover:text-[var(--nice-blue)] transition-colors">Privacy Policy</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <ul className="flex flex-col gap-3 text-sm text-[var(--text-muted)]">
                            <li><Link
                                aria-label={'Need some help?'} href="#"
                                target={'_blank'} rel={'noopener noreferrer'}
                                className="hover:text-[var(--nice-blue)] transition-colors">Help Center</Link></li>
                            <li><Link
                                aria-label={'Visit our discord community'} href="#"
                                target={'_blank'} rel={'noopener noreferrer'}
                                className="hover:text-[var(--nice-blue)] transition-colors">Discord Community</Link></li>
                            <li><Link
                                aria-label={'Reach out to us'} href="#"
                                target={'_blank'} rel={'noopener noreferrer'}
                                className="hover:text-[var(--nice-blue)] transition-colors">Contact Us</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-[var(--layer3)] pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[var(--text-muted)]">
                    ...
                    <div className="flex gap-6">
                        <Link
                            ...
                            href="#"
                            className="hover:underline">Terms of Service</Link>
                        <Link
