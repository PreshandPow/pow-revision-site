    ...
    return (
        <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <motion.div
                ...
                className="relative flex flex-col w-full max-w-[420px] bg-[var(--layer1)] border border-[var(--layer3)]
            ...
            >
                ...
                <div className="px-6 pb-6 max-h-[300px] overflow-y-auto custom-scrollbar flex flex-col gap-2">
                    ...
                    <div>
                        ...
                        <div
                            className="flex items-center gap-3 w-full p-3 rounded-lg border border-[var(--nice-blue)]
                            bg-[var(--nice-blue)]/5 text-left"
                        >
                    ...
                    {!isAtRoot && (
                        ...
                        >
                            <div
                                className={`p-1.5 rounded-md ${selectedDestination === 'root' ? 'bg-[var(--nice-blue)] text-white' : 'bg-[var(--layer3)] text-[var(--text-muted)]'}`}
                            >
                                <Folder size={18} />
                            </div>
                    ...
                    {availableFolders.length === 0 ? (
                        <div
                            className="text-center py-8 text-sm text-[var(--text-muted)] border border-dashed
                            border-[var(--layer3)] rounded-xl bg-[var(--layer2)]/50 mt-1"
                        >
                        ...
                        <div className="flex flex-col gap-2">
                            {availableFolders.map((folder) => (
                                ...
                                >
                                    <div
                                        className={`p-1.5 rounded-md ${selectedDestination === folder.id ? 'bg-[var(--nice-blue)] text-white' : 'bg-[var(--layer3)] text-[var(--text-muted)]'}`}
                                    >
                                        <Folder
                                            size={18}
                                            fill={selectedDestination === folder.id ? "currentColor" : "none"}
                                        />
                                    </div>
                                    <span className="text-sm font-medium truncate text-[var(--text)]">
                ...
                <div className="px-6 py-4 bg-[var(--layer2)]/50 border-t border-[var(--layer3)] flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className="px-4 py-2 text-sm font-semibold rounded-lg bg-[var(--nice-blue)] text-white shadow-sm
                        hover:opacity-90 active:scale-95 transition-all cursor-pointer disabled:opacity-50
